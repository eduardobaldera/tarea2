...
public class CompraControlador extends BaseControlador {
    FakeServices fakeServices = FakeServices.getInstancia();

    public CompraControlador(Javalin app) {
        super(app);
    }
        ...
        app.routes(() -> {
            path("/comprar/", () -> {
                ...
                get("/listar", ctx -> {
                    ...
                    ctx.render("/templates/crud-tradicional/compraLista.html", modelo);
                });
